...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://cdn.jsdelivr.net/gh/Cloud420/Bot-master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "SmorcBot :smorc: ",
        loggedInID: null,
        scriptLink: "https://cdn.jsdelivr.net/gh/Cloud420/Bot-master/basicBot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://cdn.jsdelivr.net/gh/Cloud420/Bot-master/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            ball: [
           "I don't even want to answer you :glare: ",
            "Signs point to yes. :moonmoon::peace: ",
            "Yes. :opieop: ",
            "Dumb Question Ask Another :smorc: ",
            " :pogchamp: 清创柴草 :pogchamp: ",
            "In Your Dreams",
            "Obviously :legit: ",
            "Yeah Right",
            "Outcome hazy, you money-hungry dick. :swiftrage: ",
            "definitely. Unless it doesn’t happen. Listen it’s not my fault your father didn’t love you. Get off my back!",
            "signs point to yes. But on second thought, go fuck yourself.",
            "Fuck You",
            "bb pls :babby:",
        ...
        commands: {
            ...
            // bannersCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.banners)
                    // }
                // }
            // },
            ...
            // belyCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.bely)
                    // }
                // }
            // },
            ...
            // sanicCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.sanic)
                    // }
                // }
            // },
            ...
            // cutesanicCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.cutesanic)
                    // }
                // }
            // },
            ...
            // kolentoCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.kolento)
                    // }
                // }
            // },
            ...
            // streamCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.stream)
                    // }
                // }
            // },
            ...
            // danmarkCommand: {
                ...
                // functionality: function (chat, cmd) {
                    ...
                    // if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                    // else {
                        // API.sendChat(basicBot.chat.danmark)
                    // }
                // }
            // },
